...
var ngSoundManager = angular.module('angularSoundManager', ['ngCookies'])
        ...
        return {
            ...
            init: function() {
                ...
                $document.bind('keydown', function(e){
                    ...
                    //console.log(e.which);
                    if(e.which === 32 || e.which === 80) { //space, P
                       // e.preventDefault();                        
            ...
            addToPlaylist: function(track) {
            	...
            	if(playlist.length == 1){
            		if(this.getCurrentTrack() === null) {
                        ...
                        trackId = soundManager.soundIDs[0];
...
ngSoundManager.directive('volumeSlider', ['angularPlayer',
    function(angularPlayer) {
        return {
            restrict: "EA",
            link: function(scope, element, attrs) {
                element.bind('change', function(event) {                	
                    angularPlayer.adjustVolumeSlider(element.val());
                    if(element.val() == 0){
                    	$('#volume-button').addClass('off');
                    }else{
                    	$('#volume-button').removeClass('off');
                    }
                });
