...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , generateMonthAndYearHeader = function generateMonthAndYearHeader(prevButton, nextButton, preventMobile) {
      ...
      return [
        '<div class="_720kb-datepicker-calendar-header picker__header">',
          '<div class="_720kb-datepicker-calendar-header-left">',
            ...
            '</a>',
          '</div>',
          '<div class="picker__month _720kb-datepicker-calendar-header-middle _720kb-datepicker-calendar-month">',
            '{{month}}&nbsp;',
            '<a class="picker__year" href="javascript:void(0)" ng-click="paginateYears(year); showYearsPagination = !showYearsPagination;">',
              '<span>',
                '{{year}}',
    ...
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton, preventMobile) {
      ...
      var toReturn = [
        '<div class="picker__frame"><div class="picker__wrap"><div class="picker__box _720kb-datepicker-calendar {{datepickerClass}} {{datepickerID}}" ng-class="{\'_720kb-datepicker-forced-to-open\': checkVisibility()}" ng-blur="hideCalendar()">',
        '</div></div></div>'
      ]
